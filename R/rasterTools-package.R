...
#' \code{\link{generate}}, \code{\link{obtain}}, \code{\link{modify}} and
#' \code{\link{measure}}.
#'
#' The workflow of each of these functions comprises specific operators,
#' functions that carry out a certain operation. Operators are combined to
