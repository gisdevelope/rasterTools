...
The rasterTools package provides a toolchain for a transparent and reproducible workflow to obtain and process spatial (earth observation) data for an evidence based approach to landscape ecological questions. Keywords: *earth observation data*, *spatial patterns*, *species distribution models*, *land-use*, *landscape metrics*, *(neutral) landscape models*, *evidence based science*
