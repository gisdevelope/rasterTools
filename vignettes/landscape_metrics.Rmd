...
In the following you will find a list of the generic metrics defined (so far) and below that the derived metrics sorted into the groups defined in @mcgarigal_fragstats_2015:
