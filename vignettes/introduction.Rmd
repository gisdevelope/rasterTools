...
The so defined *terms* are the basis for derived metrics. Such a metric is defined simply by its mathematical equation, for example the *Class proportional area* is the class areas divided by the window area (*a_c / a_w * 100*). 
...
Several derived metrics can be defined in one algorithm, given the required terms are also defined
