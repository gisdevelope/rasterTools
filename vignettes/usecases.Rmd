...
Moreover, we need to create a frequently occurring derivations thereof, a binarised raster, where some class(es) have been set as focal class. Here we derive them from the categorical raster, but this could as well be done from the continuous raster.
