...
test_that("Error if arguments have wrong value", {
  ...
  expect_error(geomSquare(anchor = "bla"))
  expect_error(geomSquare(anchor = coords, window = "bla"))
  expect_error(geomSquare(anchor = coords, features = "bla"))
  expect_error(geomSquare(template = "bla"))
})
